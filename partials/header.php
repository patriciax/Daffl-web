...
<body>
    ...
    <header>
        <nav class="header-nav fixed z-50 bg-white lg:flex-row bg-white  flex-col top-0 flex items-center justify-between w-full text-lg text-gray-700 px-5  lg:px-10 py-4">
            ...
            <div class="hidden  lg:flex items-center mt-4" id="menu">
                <ul class="pt-4 text-base text-secondary lg:flex md:justify-between md:pt-0 items-center font-semibold">
                    ...
                    <li class="relative xl:mr-10  lg:mr-6  py-2 block hover:text-primary hover-drop">
                        <input type="checkbox" id="sortbox" class="hidden absolute">
                        <label for="sortbox" class="flex items-center space-x-1 cursor-pointer">
                            <span class="">Sé un daffler</span>
